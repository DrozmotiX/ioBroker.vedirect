...
const state_attrb = {
    ...
    LOAD: {
        // Datentyp? eigentlich On / OFF als text aber man könnte auch boolean Datentyp draus machen aber dann ist es nicht mehr der Name so wie er in der Protokollbeschreibung steht
    ...
    TTG: {
        // Welche ROLE? gibt keine Minuten und sekunden als role in IoBroker
        name: 'Time to go',
        type: 'number',
        role: 'value',
        unit: 'Minutes',
    ...
    AR: {
        // Welche ROLE? kommt als String und muss ein String bleiben da dies der Grund für den Alarm ist
        name: 'Alarm reason',
        type: 'string',
        role: 'text',
        unit: '',
    ...
    OR: {
        // Welche ROLE? kommt als String und muss ein String bleiben da dies der Grund für den Abschaltgrund ist
        name: 'Off reason',
        type: 'string',
        role: 'text',
        unit: '',
    ...
    H4: {
        // Welche ROLE?  cycles (wie oft dieser Zustand eingetreten ist)
    ...
    H9: {
        // Welche ROLE? wenn es sekunden geben würde!!
